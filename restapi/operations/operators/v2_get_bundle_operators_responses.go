...
func (o *V2GetBundleOperatorsOK) WithPayload(payload []models.OperatorProperties) *V2GetBundleOperatorsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the v2 get bundle operators o k response
func (o *V2GetBundleOperatorsOK) SetPayload(payload []models.OperatorProperties) {
	o.Payload = payload
}
...
func (o *V2GetBundleOperatorsOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]models.OperatorProperties, 0, 50)
	}
