...
type V2ListBundlesOK struct {
	...
	/*
	  In: Body
	*/
	Payload []models.BundleName `json:"body,omitempty"`
}
...
func (o *V2ListBundlesOK) WithPayload(payload []models.BundleName) *V2ListBundlesOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the v2 list bundles o k response
func (o *V2ListBundlesOK) SetPayload(payload []models.BundleName) {
	o.Payload = payload
}
...
func (o *V2ListBundlesOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]models.BundleName, 0, 50)
	}
