...
run-db-container:
	...
	$(CONTAINER_COMMAND) run -d  --rm --tmpfs /var/lib/pgsql/data:size=32G --name postgres -e POSTGRESQL_ADMIN_PASSWORD=admin -e POSTGRESQL_MAX_CONNECTIONS=10000 -p 127.0.0.1:5433:5432 \
		$(PSQL_IMAGE)
