...
const (
	...
	// BundleOpenshiftAI captures enum value "Openshift AI"
	BundleOpenshiftAI Bundle = "Openshift AI"
)
...
func init() {
	var res []Bundle
	if err := json.Unmarshal([]byte(`["Virtualization","Openshift AI"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
